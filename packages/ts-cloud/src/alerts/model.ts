...
export interface HealthResult {
  ...
  statusCode?: number
  message?: string
  timings: { dnsMs?: number; connectMs?: number; tlsMs?: number; ttfbMs?: number; totalMs?: number }
  checkedAt: string
}
...
export interface NotificationRoute {
  ...
  channelIds: string[]
  quietHours?: { timezone: string; start: string; end: string; weekdays?: number[] }
  groupWaitSeconds: number
  reminderSeconds?: number
  escalation: Array<{ afterSeconds: number; channelIds: string[] }>
  template?: string
