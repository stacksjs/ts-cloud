...
const POLICIES: Record<string, RoutePolicy> = {
  ...
  'GET /api/health/checks': { capability: 'runtime:read' },
  'POST /api/health/checks': { capability: 'config:write' },
  'PATCH /api/health/checks': { capability: 'config:write' },
  'POST /api/health/checks/test': { capability: 'runtime:read' },
  'POST /api/health/checks/run': { capability: 'runtime:restart' },
  'GET /api/protection': { capability: 'security:read' },
  'POST /api/protection/attack-mode': { capability: 'security:manage' },
  'POST /api/protection/pause': { capability: 'security:manage' },
  'GET /api/protection/ip-rules': { capability: 'security:read' },
  'POST /api/protection/ip-rules': { capability: 'security:manage' },
  'DELETE /api/protection/ip-rules': { capability: 'security:manage' },
  // Spend is organization-scoped: reading the bill and changing a cap are
  // separate from any project permission a member holds.
  'GET /api/usage': { capability: 'billing:read' },
  'GET /api/spend/budgets': { capability: 'billing:read' },
  'POST /api/spend/budgets': { capability: 'billing:manage' },
  'PATCH /api/spend/budgets': { capability: 'billing:manage' },
  'DELETE /api/spend/budgets': { capability: 'billing:manage' },
  'POST /api/spend/check': { capability: 'billing:manage' },
  'GET /api/spend/enforcement': { capability: 'billing:read' },
  'POST /api/spend/release': { capability: 'billing:manage' },
  'GET /api/spend/anomalies': { capability: 'billing:read' },
  'POST /api/spend/anomalies/acknowledge': { capability: 'billing:manage' },
  'GET /api/alerts': { capability: 'runtime:read' },
  'GET /api/alerts/rules': { capability: 'runtime:read' },
  'POST /api/alerts/rules': { capability: 'config:write' },
  'PATCH /api/alerts/rules': { capability: 'config:write' },
  ...
  'POST /api/jobs/preview': { capability: 'automation:read' },
  'POST /api/jobs/action': { capability: 'automation:manage' },
  'POST /api/jobs/reconcile': { capability: 'automation:manage' },
  'GET /api/jobs/history': { capability: 'automation:read' },
  'GET /api/workers': { capability: 'automation:read' },
  'POST /api/workers/action': { capability: 'automation:manage' },
