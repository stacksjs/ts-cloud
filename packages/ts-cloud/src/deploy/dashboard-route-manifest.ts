...
export const dashboardPageRoutes: readonly DashboardPageRoute[] = [
  ...
  { id: 'configuration.entries', path: '/operations/configuration', label: 'Environment & secrets', group: 'operations', modes: ['server', 'serverless'], adminOnly: false, legacyPaths: ['/serverless/secrets'] },
