...
export type DashboardNavigationGroup =
  'overview' | 'applications' | 'operations' | 'infrastructure' | 'compute-data' | 'settings' | 'organization'
...
export const dashboardPageRoutes: readonly DashboardPageRoute[] = [
  ...
  {
    id: 'server.activity',
    path: '/server/activity',
    label: 'Activity',
    group: 'overview',
    modes: ['server'],
    adminOnly: true,
    legacyPaths: ['/activity'],
  },
  {
    id: 'services.list',
    path: '/server/sites',
  ...
  {
    id: 'operations.previews',
    path: '/operations/previews',
  ...
  },
  {
    ...
    modes: ['server', 'serverless'],
    adminOnly: false,
    legacyPaths: ['/server/workers', '/serverless/scheduler'],
  },
  {
    id: 'configuration.entries',
    path: '/operations/configuration',
    label: 'Environment & secrets',
    group: 'operations',
    modes: ['server', 'serverless'],
    adminOnly: false,
    legacyPaths: ['/serverless/secrets'],
  },
  {
    id: 'metrics.overview',
    path: '/server/metrics',
  ...
  },
  {
    ...
    modes: ['server', 'serverless'],
    adminOnly: false,
    legacyPaths: ['/database', '/databases', '/server/database', '/serverless/data'],
  },
  {
    id: 'network.firewall',
  ...
  },
  {
    ...
    modes: ['server', 'serverless'],
    adminOnly: false,
    legacyPaths: ['/server/security'],
  },
  {
    id: 'access.ssh',
    path: '/server/ssh-keys',
    label: 'SSH keys',
    group: 'infrastructure',
    modes: ['server'],
    adminOnly: true,
  ...
  {
    id: 'serverless.deployments',
    path: '/serverless/deployments',
    label: 'Deployments',
    group: 'overview',
    modes: ['serverless'],
    adminOnly: true,
  ...
  {
    id: 'serverless.traces',
    path: '/serverless/traces',
    label: 'Traces',
    group: 'overview',
    modes: ['serverless'],
    adminOnly: true,
  ...
  {
    id: 'serverless.queues',
    path: '/serverless/queues',
    label: 'Queues',
    group: 'compute-data',
    modes: ['serverless'],
    adminOnly: true,
  ...
  {
    id: 'serverless.assets',
    path: '/serverless/assets',
    label: 'Assets',
    group: 'compute-data',
    modes: ['serverless'],
    adminOnly: true,
  ...
  {
    id: 'serverless.alerts',
    path: '/serverless/alarms',
    label: 'Alerts',
    group: 'settings',
    modes: ['serverless'],
    adminOnly: true,
