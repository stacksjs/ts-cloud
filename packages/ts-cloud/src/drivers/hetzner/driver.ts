...
import { describeScriptSyntaxError, formatSshFailure, summarizeRemoteFailures, surfaceRemoteNotices } from '../shared/remote-failure'
...
// The failure helpers moved to `../shared/remote-failure` so the ssh driver can
// share them without importing this module; re-exported for existing callers.
export { describeScriptSyntaxError, formatSshFailure }
