...
export async function deploySiteRelease(
  ...
  // server-static sites are served by Caddy file_server (no systemd); server-app
  // sites run as a systemd service. The Caddyfile (regenerated by the driver's
  // provisioning step) wires file_server / reverse_proxy accordingly.
