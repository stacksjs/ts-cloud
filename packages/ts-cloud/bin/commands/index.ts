...
export { registerSshCommands } from './ssh'
export { registerPlacementCommands } from './placement'
export { registerRegionCommands } from './regions'
export { registerMaintenanceCommands } from './maintenance'
...
export { registerProtectCommands } from './protect'
export { registerSpendCommands } from './spend'
