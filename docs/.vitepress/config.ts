...
const title = 'ts-cloud | A TypeScript Starter Kit. For a better Development Experience.'
...
export default withPwa(
  defineConfig({
    ...
    head: [
      ...
      ['meta', {
        name: 'tags',
        content: 'ts-cloud, stacksjs, reverse proxy, modern, lightweight, zero-config, local development',
      }],
